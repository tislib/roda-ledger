...
use proto::control::{
    ...
    GetNodeLogResponse, GetRecentElectionsRequest, GetRecentElectionsResponse,
    GetScenarioStatusRequest, GetScenarioStatusResponse, GetServerInfoRequest,
    GetServerInfoResponse, HealPartitionRequest, HealPartitionResponse, KillNodeRequest,
    KillNodeResponse, ListAvailableScenariosRequest, ListAvailableScenariosResponse,
    ListScenarioRunsRequest, ListScenarioRunsResponse, NodeInfo, NodeRole, NodeStatus,
    PartitionPair as PbPartitionPair, PartitionPairRequest, PartitionPairResponse,
    ResetClusterRequest, ResetClusterResponse, RestartNodeRequest, RestartNodeResponse,
    RunScenarioRequest, RunScenarioResponse, ScenarioCategory, ScenarioRunSummary, ScenarioState,
    SetNodeCountRequest, SetNodeCountResponse, StartNodeRequest, StartNodeResponse,
    StopNodeRequest, StopNodeResponse, UpdateClusterConfigRequest, UpdateClusterConfigResponse,
    WatchClusterSnapshotRequest, WatchFunctionsRequest,
};
