...
pub(super) fn active_wal_path(data_dir: &Path) -> PathBuf {
...
pub(super) fn segment_crc_path(data_dir: &Path, id: u32) -> PathBuf {
...
pub(super) fn snapshot_crc_tmp_path(data_dir: &Path, id: u32) -> PathBuf {
...
pub(super) fn parse_segment_id(name: &str) -> Option<u32> {
